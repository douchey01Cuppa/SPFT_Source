...
void Logger::SetSPFlashToolLogFolder() {
    GetLogger().sp_flash_tool_log_path = OptionIniFileMgr::getInstance()->getLog_path().toStdString();
...
#ifdef _WIN32
    return ( std::string("\\SP_FT_V6_Dump_") + GetLogger().pimpl->GetTimestamp() );
#else
    return ( std::string("/SP_FT_V6_Dump_") + GetLogger().pimpl->GetTimestamp() );
#endif
}
...
void Logger::DebugOff() {
    ...
    Logger::GetLogger()<<Logger::Debug<<
            "================================================================="
            "================================================================="
            <<std::endl<< qPrintable(STRING_TOOL_NAME) <<"runtime trace is OFF"<<std::endl<<
            "================================================================="
            "================================================================="
            <<std::endl;
